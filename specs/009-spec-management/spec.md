...
public sealed class SpecManager
{
    ...
    public Task<string?> LoadSpecContextWithRelevanceAsync(string query, int topK = 5);
    public Task<List<SpecSearchResult>> SearchSpecsAsync(string query, int topK = 10);
