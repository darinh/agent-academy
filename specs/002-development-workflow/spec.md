...
- ~~No automated changelog generation from conventional commits yet.~~ — **Resolved**: `scripts/generate-changelog.sh` generates `CHANGELOG.md` from conventional commits. Called by `version-bump.yml` on merge to `main`. *Tracked in #10*
