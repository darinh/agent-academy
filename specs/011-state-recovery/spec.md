...
- No restart history UI (list of past restarts with timestamps and reasons) — **partial**: REST API available at `GET /api/system/restarts` and `GET /api/system/restarts/stats`; frontend UI not yet implemented
