...
public sealed class RoomAgentEndpointTests : IDisposable
{
    ...
    public RoomAgentEndpointTests()
    {
        ...
        var roomService = new RoomService(_db, NullLogger<RoomService>.Instance, activityPublisher, messageService, new RoomSnapshotBuilder(_db, _catalog, new PhaseTransitionValidator(_db)), new PhaseTransitionValidator(_db), _catalog);
