...
public class SprintControllerTests : IDisposable
{
    ...
    public SprintControllerTests()
    {
        ...
        var taskOrchestration = new TaskOrchestrationService(_db, NullLogger<TaskOrchestrationService>.Instance, catalog, activityPublisher, taskLifecycle, roomService, roomLifecycle, agentLocations, messageService, breakouts);
