...
namespace AgentAcademy.Server.Data.Migrations
{
    ...
    [Migration("20260428054338_AddSprintTerminalCeremonyColumns")]
    partial class AddSprintTerminalCeremonyColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgentAcademy.Server.Data.Entities.SprintArtifactEntity", b =>
                {
                    ...
                    b.HasIndex("SprintId", "Type", "CreatedAt")
            ...
            modelBuilder.Entity("AgentAcademy.Server.Data.Entities.SprintEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("FinalSynthesisEnteredAt")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("LastRoundCompletedAt")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("LastSelfEvalAt")
                        .HasColumnType("TEXT");

                    b.Property<string>("LastSelfEvalVerdict")
                        .HasColumnType("TEXT");

                    b.Property<int?>("MaxRoundsOverride")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("RoundsThisSprint")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);

                    b.Property<int>("RoundsThisStage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);

                    b.Property<int>("SelfDriveContinuations")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);

                    b.Property<int>("SelfEvalAttempts")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime?>("SelfEvalStartedAt")
                        .HasColumnType("TEXT");

                    b.Property<bool>("SelfEvaluationInFlight")
                        .HasColumnType("INTEGER");
